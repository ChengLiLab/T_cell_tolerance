...
do
    ...
    python ./code/creat_cis_matrix.py -i ./tmp.data/result/chr${i}_reads.txt  -o ./resolution_500k/cis/raw/chr${i}_500k_rawmatrix.txt -chr $i -resolution 500000
done
...
do
    ...
    do
        ...
        #creat interaction matrix, 构建相互作用矩阵
        python ./code/creat_trans_matrix.py -i ./tmp.data/result/chr${i}_${j}_reads.txt  -o ./resolution_500k/trans/raw/chr${i}_${j}_500k_rawmatrix.txt -chr1 $i -chr2 $j -resolution 500000
    done
done