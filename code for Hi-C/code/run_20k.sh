mkdir resolution_20k
mkdir ./resolution_20k/cis
mkdir ./resolution_20k/trans
mkdir ./resolution_20k/cis/raw
mkdir ./resolution_20k/cis/normalization
mkdir ./resolution_20k/trans/raw
mkdir ./resolution_20k/trans/normalization
...
do
    ...
    python /lustre/user/liclab/lirf/Project/hic/bgi/5534N/code/creat_cis_matrix.py -i ./tmp.data/result/chr${i}_reads.txt  -o ./resolution_20k/cis/raw/chr${i}_20k_rawmatrix.txt -chr $i -resolution 20000
done
###############################################################
