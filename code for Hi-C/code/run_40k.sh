...
do
    ...
    python /lustre/user/liclab/lirf/Project/hic/bgi/5534N/code/creat_cis_matrix.py -i ./tmp.data/result/chr${i}_reads.txt  -o ./resolution_40k/cis/raw/chr${i}_40k_rawmatrix.txt -chr $i -resolution 40000
done
###############################################################
...
do
    ...
    do
        ...
        #creat interaction matrix, 构建相互作用矩阵
        python /lustre/user/liclab/lirf/Project/hic/bgi/5534N/code/creat_trans_matrix.py -i ./tmp.data/result/chr${i}_${j}_reads.txt  -o ./resolution_40k/trans/raw/chr${i}_${j}_40k_rawmatrix.txt -chr1 $i -chr2 $j -resolution 40000
    done
done
